...
$ruleFile = Join-Path -Path $PSScriptRoot -ChildPath 'rules' -AdditionalChildPath '04-fileWithRules-auto-reasons.Rule.ps1' -Resolve

$ruleOptions = New-PSRuleOption -TargetName id -TargetType type
