...
$ruleFile = Join-Path -Path $PSScriptRoot -ChildPath 'rules' -AdditionalChildPath '04-fileWithRules-services.Rule.ps1' -Resolve

$ruleOptions = New-PSRuleOption -TargetName id -Convention 'userResolver.init','userResolver.resolve'
